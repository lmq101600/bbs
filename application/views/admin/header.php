...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top my-navbar">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="./index.php?route=admin/index">淮北选煤厂论坛</a>
    </div>
    <div id="navbar" class="navbar-collapse collapse">
        ...
        <li><a href="./index.php?route=admin/replies"><i class="fa fa-reply"></i> 回复</a></li>
<!--        <li><a href="./index.php?route=admin/clean"><i class="fa fa-send"></i> 消息清理</a></li>-->
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a target="_blank" href="/">访问前台</a></li>

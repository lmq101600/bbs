...
<!--					</a>-->
				...
				<div class="col-md-11 post-text">
					<?php echo $p['content'];?>
					<p class="pinfo">作者：<?php echo $this->general("getnamebyuid",$p['userid']);?><span class="split"></span><small><em>时间：<?php echo date("Y-m-d H:i",strtotime($p['time']));?></em></small></p>
				</div>
			</div>
		...
		<?php	}	$num++;
			if(!empty($p['rcontent'])){	?>
				<div class="row">
				<div class="col-md-1">
                    <span style="font-weight: bold;color: #407BB9"><?php echo $num?>#：</span>
...
<!--					</a>-->
				...
				<div class="col-md-11 post-text">
					<?php echo $p['rcontent'];?>
					<p class="pinfo">作者：<?php echo $this->general("getnamebyuid",$p['ruserid']);?><span class="split"></span><small><em>时间：<?php echo date("Y-m-d H:i",strtotime($p['rtime']));?></em></small></p>
				</div>
			</div>
			<hr>
		<?php	}}}	?>	
...
<?php } ?>
			<form id="replypost" role="form" class="form-padding">
			  <div class="form-group">
                ...
                dictDefaultMessage: "点击上传文件（支持JPG、GIF、PNG、PDF格式）",
